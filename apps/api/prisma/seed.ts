import { PrismaClient, AdPlatform, CampaignStatus, AdType, RecommendationType, Priority } from '@prisma/client';
...
async function seed() {
  ...
  const platforms: AdPlatform[] = ['GOOGLE_ADS', 'META', 'LINKEDIN', 'TIKTOK'];
  ...
  for (const account of adAccounts) {
    ...
    for (const name of names) {
      ...
      // Create ads
      const adTypes: AdType[] = ['IMAGE', 'VIDEO', 'RESPONSIVE'];
